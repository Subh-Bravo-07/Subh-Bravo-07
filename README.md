...
<img align="right" src="https://gifdb.com/images/high/ghost-cod-sitting-while-holding-two-guns-dnq81ojlqqni27qb.webp" width="260" alt="Ghost Cod" />
...
Location : India 🇮🇳
Status   : [ ████████░░ ] Leveling Up...
Motto    : "The best firewall is curiosity — it blocks
            ignorance and lets knowledge through 🔐"
```

- 🔭 **Currently** — Building secure web apps & crushing ethical-hacking challenges
- 🌱 **Deep-diving into** — Advanced Web Exploitation, Threat Modeling, Malware Analysis & Reverse Engineering, Python/Bash Security Automation
- 🤝 **Open to** — CTF collaborations, open-source security tooling, full-stack projects with a security-first mindset
- 💬 **Ask me about** — Web Dev (HTML/CSS/JS), Linux internals, Python scripting, Java, MySQL
...
| ![HackTheBox](https://img.shields.io/badge/Hack_The_Box-Active-9FEF00?style=flat-square&logo=hackthebox&logoColor=black) | 🟢 Active | Machines & Challenges |
| ![PicoCTF](https://img.shields.io/badge/PicoCTF-Competing-3D9970?style=flat-square) | 🟡 Competing | Annual events |
